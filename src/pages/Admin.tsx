    ...
    setTransactionLogs([
      {
        ...
        message: "Venda Pix R$ 1999,00 - Pedido #ALF238763",
      },
      {
        time: new Date().toLocaleString(),
        message: "Venda Cartão R$ 7999,00 - Pedido #ALF238764",
      },
    ]);
    setErrorLogs([
      {
        time: new Date().toLocaleString(),
        message: "Falha ao processar pagamento do pedido #ALF238765",
      },
    ]);
  }, []);
          ...
          <Tabs defaultValue="products" className="space-y-6">
            ...
            <TabsContent value="promotions">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card className="lg:col-span-1 bg-alphadarkblue border-gray-700">
                  <CardHeader>
                    <CardTitle className="text-white">New Promotion</CardTitle>
                    <CardDescription>
                ...
                <Card className="lg:col-span-2 bg-alphadarkblue border-gray-700">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Manage the promotions available on the website
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
            ...
            <TabsContent value="payments">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4 max-h-[400px] overflow-y-auto">
                      <div className="flex justify-between p-4 bg-alphadark rounded-lg border border-gray-700">
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">
                            {new Date().toLocaleDateString("pt-BR")} - Credit
                            card
                          </p>
                        </div>
                      ...
                      <div className="flex justify-between p-4 bg-alphadark rounded-lg border border-gray-700">
                        <div>
                          ...
                          <p className="text-gray-400 text-xs">
                            {new Date().toLocaleDateString("pt-BR")} - Ticket
                          </p>
                        </div>
                        <div className="flex flex-col items-end">
                          <span className="text-white font-medium">
                ...
                <Card className="mt-6 bg-alphadarkblue border-gray-700">
                  <CardHeader>
                    <CardTitle className="text-white">Sales Logs</CardTitle>
                    <CardDescription>Latest sales recorded</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2 max-h-40 overflow-y-auto">
                      ...
                      {transactionLogs.map((log, idx) => (
                        <div
                          key={idx}
                          className="text-green-400 text-xs border-b border-gray-700 pb-1 mb-1"
                        >
                  ...
                  <CardContent>
                    <div className="space-y-2 max-h-40 overflow-y-auto">
                      ...
                      {errorLogs.map((log, idx) => (
                        <div
                          key={idx}
                          className="text-red-400 text-xs border-b border-gray-700 pb-1 mb-1"
                        >
                          <span className="font-mono">[{log.time}]</span>{" "}
                          {log.message}
                        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="bg-alphadarkblue border-gray-700">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Manage administrative access settings
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400">
                        This email will be used for login and receiving OTP
                        codes
                      </p>
                    </div>
                ...
                <Card className="bg-alphadarkblue border-gray-700">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-gray-400">
                        Configure this URL in your payment gateway
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400">
                        This key is used to verify the authenticity of webhooks
                      </p>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="lg:col-span-2 bg-alphadarkblue border-gray-700">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Traffic statistics on key pages
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                ...
                <Card className="bg-alphadarkblue border-gray-700">
                  <CardHeader>
                    ...
                    <CardDescription>Cart abandonment rate</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm text-gray-400 mt-4">
                        {metrics.cartAbandonment}% of users abandon their cart
