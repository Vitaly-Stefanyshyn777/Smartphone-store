          ...
          {cartItems.length > 0 ? (
                  ...
                  <div className="space-y-6">
                    {cartItems.map((item) => {
                      ...
                      return (
                        <div
                          key={item.product.id}
                          className="flex flex-col sm:flex-row gap-4 pb-6 border-b border-gray-700"
                        >
                            ...
                            <Link to={`/product/${item.product.id}`}>
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  target.src =
                                    "https://placehold.co/96x96/alphadark/gray?text=Imagem+Indisponível";
                                }}
                              />
                            </Link>
                          </div>
                          ...
                          <div className="flex-grow">
                            <Link
                              ...
                              className="text-white hover:text-alphablue font-medium block"
                            >
                              {item.product.name}
                            </Link>
              ...
              <div>
                <div className="bg-alphadarkblue rounded-xl p-6 sticky top-24">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-300">Freight:</span>
                      <span className="text-alphablue">Free</span>
                    </div>
                      ...
                      <div className="bg-white/10 p-2 rounded-md flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            const target = e.target as HTMLImageElement;
                            target.src =
                              "https://placehold.co/24x24/alphadark/gray?text=VISA";
                          }}
                        />
                      </div>
                      <div className="bg-white/10 p-2 rounded-md flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            const target = e.target as HTMLImageElement;
                            target.src =
                              "https://placehold.co/24x24/alphadark/gray?text=MC";
                          }}
                        />
                      </div>
                      <div className="bg-white/10 p-2 rounded-md flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            const target = e.target as HTMLImageElement;
                            target.src =
                              "https://placehold.co/24x24/alphadark/gray?text=PIX";
                          }}
                        />
                      </div>
                      <div className="bg-white/10 p-2 rounded-md flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            const target = e.target as HTMLImageElement;
                            target.src =
                              "https://placehold.co/24x24/alphadark/gray?text=BOLETO";
                          }}
                        />
                      </div>
                      <div className="bg-white/10 p-2 rounded-md flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            const target = e.target as HTMLImageElement;
                            target.src =
                              "https://placehold.co/24x24/alphadark/gray?text=AMEX";
                          }}
                        />
                      </div>
                    </div>
            ...
            <div className="bg-alphadarkblue rounded-xl p-10 text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-300 mb-6">
                ...
                products and find what you need!
              </p>
              <Link
                to="/produtos"
