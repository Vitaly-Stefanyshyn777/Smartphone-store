    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `${quantity}x ${product.name} ${
          isProductInCart ? "(atualizado)" : "adicionado"
        } ao carrinho.`,
      });
                ...
                <div className="relative pb-[100%] overflow-hidden rounded-lg mb-4">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src =
                        "https://placehold.co/600x600/alphadark/gray?text=Imagem+Indisponível";
                    }}
                  />
                  {product.discount && (
              ...
              <div className="bg-alphadarkblue rounded-xl p-6">
                <div>
                  <div className="flex items-center gap-2 text-alphablue mb-2">
                    <span className="px-2 py-0.5 bg-alphablue/10 rounded text-sm font-medium">
                      {product.category}
                    </span>
                    {product.inStock ? (
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <a
                        ...
                        className={`flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-4 rounded-md h-12 transition-colors ${
                          isMobile ? "w-full" : ""
                        }`}
                      >
                        <svg
                    ...
                    <div className="bg-alphadark/50 rounded-lg p-4 flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-white text-sm font-medium">
                          Free Delivery to all of Brazil
                        </p>
                        <p className="text-gray-400 text-xs">
                          Estimated delivery time: 7 to 15 business days
                        </p>
                        <p className="text-white text-xs mt-2">
                          If you have any questions, please contact us via
                          WhatsApp: 13 99611-4479
                        </p>
                      </div>
                    </div>
                  </div>
