...
const Index = () => {
  ...
  const featuredProducts = products.filter(
    (product) => product.isNew || product.discount
  );
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Discover our full catalog of premium Apple products and selected
                accessories with warranty and fast delivery.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-alphadarkblue/70 rounded-lg p-4 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Safe environment for your purchases
                </p>
              </div>
              ...
              <div className="bg-alphadarkblue/70 rounded-lg p-4 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Partnership with the best carriers
                </p>
              </div>
              ...
              <div className="bg-alphadarkblue/70 rounded-lg p-4 flex flex-col items-center justify-center text-center">
                ...
                <h4 className="text-white font-medium">Extended Warranty</h4>
                <p className="text-gray-400 text-sm mt-1">
                  Up to 1 year warranty on all products
                </p>
              </div>
