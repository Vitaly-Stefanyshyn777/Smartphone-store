        ...
        <div className="bg-alphadarkblue/60 backdrop-blur-md rounded-2xl border border-white/5 overflow-hidden">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <span className="text-gradient text-sm font-medium uppercase tracking-wider">
                Special offer
              </span>
              ...
              <p className="text-gray-300 mt-4 mb-6">
                Take advantage of our special promotions on select iPhones and
                accessories. Limited-time offers with free shipping and extended
                warranty!
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <div className="text-alphagreen mt-1">Up to 20% OFF</div>
                </div>
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="text-2xl text-white font-bold">
                    Accessories
                  </div>
                  <div className="text-alphagreen mt-1">Up to 30% OFF</div>
                </div>
              </div>
              ...
              <div className="mt-6 flex items-center">
                <div className="mr-4 flex -space-x-2">
                  <div className="w-8 h-8 rounded-full bg-alphablue flex items-center justify-center text-white text-xs">
                    JM
                  </div>
                  <div className="w-8 h-8 rounded-full bg-alphapurple flex items-center justify-center text-white text-xs">
                    CM
                  </div>
                  <div className="w-8 h-8 rounded-full bg-alphagreen flex items-center justify-center text-white text-xs">
                    SP
                  </div>
                </div>
                <div className="text-sm text-gray-400">+15 people enjoyed</div>
              </div>
            </div>
          </div>
        </div>
