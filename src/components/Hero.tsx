        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="md:w-1/2 text-center md:text-left space-y-6">
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-lg mx-auto md:mx-0">
              The best Apple products and premium accessories with fast delivery
              and warranty.
            </p>
            ...
            <div className="flex items-center justify-center md:justify-start space-x-4 pt-2">
              ...
              <div className="flex items-center space-x-1">
                <span className="text-alphagreen text-sm">✓</span>
                <span className="text-gray-400 text-sm">Extended warranty</span>
              </div>
              <div className="flex items-center space-x-1">
                <span className="text-alphagreen text-sm">✓</span>
                <span className="text-gray-400 text-sm">Secure purchase</span>
              </div>
            </div>
          </div>
