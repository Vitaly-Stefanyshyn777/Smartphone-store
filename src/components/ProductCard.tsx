    ...
    <div className="bg-alphadarkblue rounded-xl overflow-hidden transition-all duration-300 hover:translate-y-[-5px] group">
          ...
          <div className="overflow-hidden aspect-square">
            <img
              ...
              onError={(e) => {
                ...
                target.src =
                  "https://placehold.co/300x300/alphadark/gray?text=Imagem+Indisponível";
              }}
            />
          </div>
            ...
            <div className="absolute bottom-3 left-3 bg-white/10 backdrop-blur-md text-white text-xs py-1 px-2 rounded-full flex items-center">
              <img
                ...
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.src =
                    "https://placehold.co/12x12/alphadark/gray?text=L";
                }}
              />
              Fast delivery
            </div>
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex flex-col gap-2">
          ...
          <button
            className={`${
              addedToCart ? "bg-alphagreen" : "bg-gradient-tech"
        ...
        <div className="mt-3 text-xs text-center">
          ...
          <span className="text-gray-400 ml-1">1 year warranty</span>
        </div>
      </div>
    </div>
  );
